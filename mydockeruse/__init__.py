...
__F = [(_clsr(_clsr(default_docker_environment.containers.run)(stdin_open=True, tty=True, detach=True)), default_docker_environment.images)]
(lambda x=__F[0][1]:__F.append([staticmethod(f) for f in (x.pull, _clsr(x.remove)(force=True))]))()
